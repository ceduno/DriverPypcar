...
public class SwipeAnimationButton extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        //defaultDrawable = ContextCompat.getDrawable(context, ta.getInteger(R.styleable.SwipeAnimationButton_defaultDrawable, R.drawable.ic_mano));
        ...
        mBackground.setBackground(ContextCompat.getDrawable(context, ta.getInteger(R.styleable.SwipeAnimationButton_backgroundVaue, R.drawable.shape_rounded)));
        mBackground.setPadding(10, 50, 40, 80);
        addView(mBackground, layoutParamsView);

        final ImageView swipeButton = new ImageView(context);
        this.slidingButton = swipeButton;

        //rightSwipeDrawable = ContextCompat.getDrawable(getContext(), ta.getInteger(R.styleable.SwipeAnimationButton_rightSwipeDrawable, R.drawable.shape_button));
        ...
        //leftSwipeDrawable = ContextCompat.getDrawable(getContext(), ta.getInteger(R.styleable.SwipeAnimationButton_leftSwipeDrawable, R.drawable.ic_cancelar));
    ...
    private void collapseButton() {
        ...
        widthAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                slidingButton.setPadding(30, 30, 30, 30);
                //defaultBackground = ContextCompat.getDrawable(context, ta.getInteger(R.styleable.SwipeAnimationButton_defaultBackground, ));
                //slidingButton.setImageDrawable(defaultDrawable);
...
/*
    ...
    public void moveToLeft() {
        final ValueAnimator positionAnimator =
                ValueAnimator.ofFloat(slidingButton.getWidth(), 0);
        positionAnimator.setInterpolator(new AccelerateDecelerateInterpolator());
        positionAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                float x = (Float) positionAnimator.getAnimatedValue();
                slidingButton.setX(slidingButton.getX() - (slidingButton.getWidth() / 2));
            }
        });
        positionAnimator.setDuration(mDuration);
        AnimatorSet animatorSet = new AnimatorSet();
